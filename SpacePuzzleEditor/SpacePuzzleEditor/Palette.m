...
-(IBAction)solidClick:(id)sender {
    ...
    [self setSelectedIndicatorIsHiddenSolid:NO IsCracked:YES IsVoid:YES isStart:YES isFinished:YES
                                     isRock:YES isStar:YES isEraser:YES isStarButton:YES isBridgeButton:YES];
...
-(IBAction)rockClick:(id)sender {
    [self setSelectedIndicatorIsHiddenSolid:YES IsCracked:YES IsVoid:YES isStart:YES isFinished:YES
                                     isRock:NO isStar:YES isEraser:YES isStarButton:YES isBridgeButton:YES];
    [self notifyText:@"RockClick" Object:Nil Key:@"RockClick"];
}

- (IBAction)starClick:(id)sender {
    [self setSelectedIndicatorIsHiddenSolid:YES IsCracked:YES IsVoid:YES isStart:YES isFinished:YES
                                     isRock:YES isStar:NO isEraser:YES isStarButton:YES isBridgeButton:YES];
    [self notifyText:@"StarClick" Object:Nil Key:@"StarClick"];
}

- (IBAction)eraserClick:(id)sender {
    [self setSelectedIndicatorIsHiddenSolid:YES IsCracked:YES IsVoid:YES isStart:YES isFinished:YES isRock:YES isStar:YES isEraser:NO isStarButton:YES isBridgeButton:YES];
...
-(IBAction)starButtonClick:(id)sender {
    [self setSelectedIndicatorIsHiddenSolid:YES IsCracked:YES IsVoid:YES isStart:YES isFinished:YES isRock:YES isStar:YES isEraser:YES isStarButton:NO isBridgeButton:YES];
...
-(void)setSelectedIndicatorIsHiddenSolid:(BOOL)solid IsCracked:(BOOL)cracked IsVoid:(BOOL)isVoid isStart:(BOOL)start isFinished:(BOOL)finish isRock:(BOOL)rock isStar:(BOOL)star isEraser:(BOOL)eraser isStarButton:(BOOL)starbtn isBridgeButton:(BOOL)bridgebtn{
